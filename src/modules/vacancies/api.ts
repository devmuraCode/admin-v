...
export const List = ({ params }: { params: IParams }): AxiosPromise<Types.IApi.List.Response> =>
  http.request.post('/admin/vacancies/pageable', {
...
export const Single = ({ id }: { id: string }): AxiosPromise<Types.IApi.Single.Response> =>
  http.request.get(`/admin/vacancies/${id}`);
...
export const Create = ({
  ...
  http.request.post('/admin/vacancies', {
    name: values.name,
...
export const Update = ({
  ...
  http.request.put(`/admin/vacancies/${id}`, {
    name: values.name,
    salary: values.salary,
    description: values.description,
    photoId: values.photoId,
...
export const Delete = ({ id }: { id: string }): AxiosPromise<Types.IApi.Single.Response> =>
  http.request.delete(`/admin/vacancies/${id}`);
