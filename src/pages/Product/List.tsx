        ...
        <PageHeader
          ...
          buttons={[
            <Button
              ...
              container={<Link to='/product/create' />}
            />,
          ]}
        />
          ...
          columns={[
            ...
            },
            {
              ...
              render: value => {
                return (
                  <>
                    {value.map((element: { uuid: string; }, index: React.Key)=>(
                      <ImageContainer key={index} uuid={element.uuid} />
                    ))}
                  </>
                )
              },
            ...
            {
              key: 'categoryId',
              title: t('column_category'),
              dataIndex: ['categoryId', i18n.language],
            },
            {
              key: 'status',
