...
import { useList } from '@/modules/vacancies/hooks';
        ...
        <PageHeader
          ...
          buttons={[
            <Button
              ...
              container={<Link to='/vacancies/create' />}
            />,
          ]}
        />
                  ...
                  items={[
                    {
                      ...
                      variant: 'blue',
                      onClick: () => navigate(`/vacancies/update/${item.id}`),
                    },
                    {
